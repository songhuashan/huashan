...
class UserGroupModel extends Model {
	...
	protected $fields = array(0=>'user_group_id',1=>'user_group_name',2=>'ctime',3=>'user_group_icon',4=>'user_group_type',5=>'app_name',6=>'is_authenticate','school','specialty','address','s_address','other_data',7=>'pid');
	 ...
	 * @param integer $is_school 是否为机构获取数据
	 * @return array 用户组信息
	 */
	public function getUserGroup($gid = '',$is_school = 0) {
	 ...
	 */
	public function getHashUsergroup($k = 'user_group_id', $v = 'user_group_name', $is_school = 0) {
	    $list = $this->getUserGroup('',$is_school);
	    $r=array();
		$r[0]= L('PUBLIC_ALL_USERS');
	    foreach($list as $lv) {
	    	$r[$lv[$k]] = $lv[$v];
	    }
	    return $r;
