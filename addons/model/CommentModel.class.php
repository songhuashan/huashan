...
class CommentModel extends Model {
	...
	protected $fields = array('comment_id','app','table','row_id','app_uid','uid','content','to_comment_id','to_uid','data','ctime','is_del','client_type','is_audit','storey','app_detail_url','app_detail_summary','help_num');
